...
- **Safari** 16.4以上: WebCodecs API対応ですが、動作検証を行っておりません
  - 動作する可能性はありますが、保証はありません
  - 問題が発生した場合はChromeまたはEdgeをお使いください
...
A: **Google Chrome**または**Microsoft Edge**の最新版を強く推奨します。これらのブラウザでは全機能が正常に動作することを確認しています。
