...
## 2026-01-27: Git pull トラブルシューティング文書追加
- 追加ファイル: `video-encoder-app/docs/GIT_PULL_TROUBLESHOOTING.md`
- 内容: `git pull` が失敗する一般的な原因、復旧手順、注意点、よく使うコマンド、GitHub 側の設定（Default branch / Branch protection）に関する対処法を記載。